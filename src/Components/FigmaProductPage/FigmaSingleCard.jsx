                ...
                CardsData ? <> <div className=' px-[4px] pb-[4px] pt-[3px]  bg-white ' >
                    ...
                    <div className='bg-[#fcf7f4]  px-[15px]   mt-5 sm:mt-10  lg:mt-[3px]'>
                        ...
                        <div className=' flex justify-between  py-[20px] '>
                            <Link onClick={() => {
                                window.scrollTo(0, 0);
                            }} to={`/viewAllFigmaTemplate/details/${id}`}    >   <button className='text-[12px] h-[39px] w-[71px] font-bold Bold rounded-[4px] border-[1px] border-[#60599E] py-[8px] leading-[22px]	 hover:bg-[#60599E] hover:text-white'>Details</button>
